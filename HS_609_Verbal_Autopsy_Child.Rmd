...
```{r}
colnames(training_set_copy)<- mapvalues(colnames(training_set_copy), from=c("g4_06","g4_07","g4_08"), to=c("#people_live_at_address","#rooms_in_household","separate_room_for_cooking"))
```
